...
- [Bygg en JAR](./jar.md)
- [Ktor, getting started](https://ktor.io/docs/server-create-a-new-project.html) Dette er en enkel innføring i oppsett av Ktor for å lage en enkel løsning.
